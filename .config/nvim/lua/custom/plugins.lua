...
local plugins = {
  ...
  },
  {
    ...
    ft = { "markdown" },
    event = {
      "BufReadPre " .. fn.expand "~" .. "/vaults/**.md",
      "BufNewFile " .. fn.expand "~" .. "/vaults/**.md",
    },
    dependencies = {
      { "nvim-lua/plenary.nvim" },
      { "z3z1ma/nvim-cmp" },
  ...
  },
  {
    ...
    config = function()
      require "custom.configs.ui.tabby"
    end,
  },
  ----  Commandline
  {
  ...
  },
  {
    ...
    config = function()
      require "custom.configs.debugger.neodev"
    end,
  },
  --  ------------------------------------------------------------
  --  --  Editor
  ...
  },
  {
    ...
    config = function()
      require "custom.configs.editor.nvim-lightbulb"
    end,
  },
  ...
  ----  Format
  {
    ...
    config = function()
      require "custom.configs.editor.formatter"
    end,
  },
  {
    "cappyzawa/trim.nvim",
